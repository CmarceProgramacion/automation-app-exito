...
public class LoginExitoPage extends PageObject {
    public static final Target LOGIN_BTN = Target.the("Button to log in to the app").located(By.id("AppCompatButton_ingresar"));
    ...
    public static final Target ENTER_BTN = Target.the("Button to enter the application").located(By.id("AppCompatButton_ingresar"));
